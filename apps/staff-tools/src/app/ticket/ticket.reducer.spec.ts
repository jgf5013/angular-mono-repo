...
describe('ticketReducer', () => {
    ...
    it('should add tickets to the state', () => {
        ...
        const mockTickets: IExistingSupportTicket[] = [
            { id: 0, priority: 0, title: 'Test', description: 'test', status: 0, email: 'myEmail@test.nl.edu' },
            { id: 12, priority: 2, title: 'Test', description: 'test', status: 1, email: 'myEmail@test.nl.edu' }
        ];
